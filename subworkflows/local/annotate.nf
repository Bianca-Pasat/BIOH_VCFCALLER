...
include { SNPEFF_ANNOTATE } from '../../subworkflows/nf-core/snpeff_annotate'
include { ENSEMBLVEP_ANNOTATE as MERGE_ANNOTATE } from '../../subworkflows/nf-core/ensemblvep_annotate'
