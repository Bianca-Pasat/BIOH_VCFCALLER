...
/* // Check mandatory parameters
if (!params.sra) { ch_input = file(params.input) } else if (params.sra){SRA.out.samplesheet} else{ exit 1, 'Input samplesheet not specified!' }
 */
...
// try to put inside workflow without def
